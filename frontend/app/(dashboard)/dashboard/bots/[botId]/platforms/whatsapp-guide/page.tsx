    ...
    <div className="p-8 max-w-3xl">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center gap-3 mb-2">
          <div className="w-10 h-10 flex items-center justify-center bg-[#F0C020] border-4 border-[#121212] shadow-[4px_4px_0px_0px_#121212]">
            <svg viewBox="0 0 24 24" className="w-5 h-5 fill-[#121212]">
          ...
          <div>
            <p className="text-xs font-bold uppercase tracking-widest text-[#121212]/40">WhatsApp</p>
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          {[
            ...
            <div key={i} className="flex items-center gap-1.5 border-2 border-[#121212]/20 px-2.5 py-1">
              <span className="w-4 h-4 flex items-center justify-center bg-[#F0C020] text-[#121212] text-[9px] font-black">
                {i + 1}
              </span>
      ...
      <div className="mt-6 flex items-center gap-3">
        <Link
          href={`/dashboard/bots/${botId}/platforms`}
          className="inline-flex items-center gap-2 bg-[#F0C020] text-[#121212] border-2 border-[#121212] shadow-[4px_4px_0px_0px_#121212] hover:shadow-[2px_2px_0px_0px_#121212] hover:translate-x-[2px] hover:translate-y-[2px] transition-all px-5 py-2.5 text-sm font-bold uppercase tracking-wider"
        >
          Go Connect WhatsApp
        </Link>
